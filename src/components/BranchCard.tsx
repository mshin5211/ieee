...
const BranchCard = ({ title, description, src }: {
  ...
  return (
    <div className='w-full flex justify-center items-center flex-col'>
            <div className='pop-in w-full xl:w-[70%] max-md:w-[90%] rounded-full aspect-square relative flex justify-center items-center bg-[url("../images/quadDark.jpg")] dark:border-[#E8E9EA] border-[#FF5F0F] border-4'>
